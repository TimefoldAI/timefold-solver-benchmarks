...
class ExaminationConstraintProviderTest
        extends
        AbstractConstraintProviderTest<ExaminationConstraintProvider, Examination> {
    ...
    void conflictingExamsInSamePeriodTest(
        ...
        constraintVerifier.verifyThat(
                ExaminationConstraintProvider::conflictingExamsInSamePeriod)
    ...
    void periodDurationTooShortTest(
        ...
        constraintVerifier.verifyThat(
                ExaminationConstraintProvider::periodDurationTooShort)
                .given(exam)
                .penalizesBy(2);
    }
    ...
    void roomCapacityTooSmallSingleLargeExamTest(
        ...
        constraintVerifier.verifyThat(
                ExaminationConstraintProvider::roomCapacityTooSmall)
    ...
    void periodPenaltyTypeTest(
        ...
        // EXCLUSION
        constraintVerifier.verifyThat(
                ExaminationConstraintProvider::periodPenaltyExclusion)
        ...
        constraintVerifier.verifyThat(
                ExaminationConstraintProvider::periodPenaltyExamCoincidence)
                .given(periodPenalty, exam1, exam2)
                .penalizesBy(4);
        ...
        constraintVerifier.verifyThat(
                ExaminationConstraintProvider::periodPenaltyAfter)
                .given(periodPenalty, exam1, exam2)
                .penalizesBy(4);
    ...
    void roomPenaltyExclusiveTest(
        ...
        constraintVerifier.verifyThat(
                ExaminationConstraintProvider::roomPenaltyExclusive)
    ...
    void twoExamsInARowAndInADayTest(
        ...
        constraintVerifier
                .verifyThat(
                        ExaminationConstraintProvider::twoExamsInARow)
                .given(conflict, exam1, exam2)
                .penalizesBy(0);
        constraintVerifier
                .verifyThat(
                        ExaminationConstraintProvider::twoExamsInADay)
                .given(conflict, exam1, exam2)
                .penalizesBy(0);
    ...
    void periodSpreadTest(
        ...
        constraintVerifier
                .verifyThat(
                        ExaminationConstraintProvider::periodSpread)
    ...
    void mixedDurations11Test(
        ...
        constraintVerifier
                .verifyThat(
                        ExaminationConstraintProvider::mixedDurations)
                .given(exam1, exam2)
                .penalizesBy(0);
    }
    ...
    void frontLoadTest(
        ...
        constraintVerifier
                .verifyThat(ExaminationConstraintProvider::frontLoad)
                .given(exam)
                .penalizesBy(1);
    }
    ...
    void periodPenaltyTest(
        ...
        constraintVerifier
                .verifyThat(
                        ExaminationConstraintProvider::periodPenalty)
                .given(period, exam1)
                .penalizesBy(5);
    ...
    void roomPenaltyTest(
        ...
        constraintVerifier
                .verifyThat(ExaminationConstraintProvider::roomPenalty)
                .given(room, exam1)
                .penalizesBy(5);
    ...
    @Override
    protected
            ConstraintVerifier<ExaminationConstraintProvider, Examination>
