...
class ConferenceSchedulingConstraintProviderTest
    ...
    void talkPrerequisiteTalks(
        ...
        Talk talk1 = new Talk(1)
                .withRoom(room)
                .withPrerequisiteTalksCodesSet(new LinkedHashSet<>(0))
                .withTimeslot(MONDAY_9_TO_10);
        Talk talk2 = new Talk(2)
                .withRoom(room)
    ...
    void talkMutuallyExclusiveTalksTags(
        ...
        Talk talk1 = new Talk(1)
                .withRoom(room)
                .withMutuallyExclusiveTalksTagSet(new LinkedHashSet<>(0))
                .withTimeslot(MONDAY_9_TO_10);
        Talk talk2 = new Talk(2)
                .withRoom(room)
    ...
    void talkRequiredRoomTags(
        ...
        Talk talk2 = new Talk(2)
                .withRoom(room)
                .withRequiredRoomTagSet(new LinkedHashSet<>(0))
                .withTimeslot(MONDAY_10_TO_11);
    ...
    void talkProhibitedRoomTags(
        ...
        Talk talk2 = new Talk(2)
                .withRoom(room)
                .withProhibitedRoomTagSet(new LinkedHashSet<>(0))
                .withTimeslot(MONDAY_10_TO_11);
    ...
    void talkPreferredRoomTags(
        ...
        Talk talk2 = new Talk(2)
                .withRoom(room)
                .withPreferredRoomTagSet(new LinkedHashSet<>(0))
                .withTimeslot(MONDAY_10_TO_11);
    ...
    void talkUndesiredRoomTags(
        ...
        Talk talk2 = new Talk(2)
                .withRoom(room)
                .withUndesiredRoomTagSet(new LinkedHashSet<>(0))
                .withTimeslot(MONDAY_10_TO_11);
