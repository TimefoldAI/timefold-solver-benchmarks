...
<plannerBenchmark xmlns="https://timefold.ai/xsd/benchmark" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <inheritedSolverBenchmark>
        ...
        <problemBenchmarks>
            ...
            <inputSolutionFile>data/vehiclerouting/vehiclerouting-belgium-tw-n2750-k55.json</inputSolutionFile>
    ...
    <#list [5, 10, 20, 40, 80, 160, 320] as min>
      <#list [10, 20, 40, 80, 160, 320, 640] as max>
        <#if max gt min>
