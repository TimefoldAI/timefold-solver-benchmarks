...
import ai.timefold.solver.benchmarks.examples.flightcrewscheduling.score.FlightCrewSchedulingConstraintProvider;
...
public final class FlightCrewSchedulingProblem extends AbstractProblem<FlightCrewSolution> {
    ...
    protected FlightCrewSolution readOriginalSolution() {
        return new FlightCrewSchedulingXlsxFileIO()
                .read(new File("data/flightcrewscheduling/flightcrewscheduling-875-7-Europe.xlsx"));
    }
