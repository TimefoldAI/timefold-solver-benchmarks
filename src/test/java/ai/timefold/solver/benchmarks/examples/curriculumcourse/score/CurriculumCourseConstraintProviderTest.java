...
import ai.timefold.solver.benchmarks.examples.curriculumcourse.domain.Day;
...
class CurriculumCourseConstraintProviderTest
        extends
        AbstractConstraintProviderTest<CurriculumCourseConstraintProvider, CourseSchedule> {
    ...
    void conflictingLecturesDifferentCourseInSamePeriod(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::conflictingLecturesDifferentCourseInSamePeriod)
    ...
    void conflictingLecturesSameCourseInSamePeriod(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::conflictingLecturesSameCourseInSamePeriod)
    ...
    void roomOccupancy(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::roomOccupancy)
    ...
    void unavailablePeriodPenalty(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::unavailablePeriodPenalty)
    ...
    void roomCapacity(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::roomCapacity)
    ...
    void minimumWorkingDays(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::minimumWorkingDays)
    ...
    void curriculumCompactness(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::curriculumCompactness)
    ...
    void roomStability(
        ...
        constraintVerifier.verifyThat(
                CurriculumCourseConstraintProvider::roomStability)
    ...
    @Override
    protected
            ConstraintVerifier<CurriculumCourseConstraintProvider, CourseSchedule>
