package ai.timefold.solver.benchmarks.jmh.coldstart.problems;
...
public class TimeToSolverFactoryProblem implements Problem {
    ...
    public TimeToSolverFactoryProblem(Class<? extends ConstraintProvider> constraintProviderClass, Class<?> solutionClass,
            Class<?>... entityClasses) {
