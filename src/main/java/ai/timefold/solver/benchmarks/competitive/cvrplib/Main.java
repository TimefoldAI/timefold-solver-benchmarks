...
public class Main
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException, IOException {
        ...
        benchmark.run(List.of(CVRPLIBConfiguration.COMMUNITY_EDITION, CVRPLIBConfiguration.COMMUNITY_RECONFIGURATION_EDITION,
                CVRPLIBConfiguration.DLAS_RECONFIGURATION_EDITION), CVRPLIBDataset.values());
    }
