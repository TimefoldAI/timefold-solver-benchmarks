package ai.timefold.solver.benchmarks.examples.pas.score;
...
import ai.timefold.solver.benchmarks.examples.pas.domain.AdmissionPart;
import ai.timefold.solver.benchmarks.examples.pas.domain.Bed;
import ai.timefold.solver.benchmarks.examples.pas.domain.BedDesignation;
import ai.timefold.solver.benchmarks.examples.pas.domain.Department;
import ai.timefold.solver.benchmarks.examples.pas.domain.DepartmentSpecialism;
import ai.timefold.solver.benchmarks.examples.pas.domain.Equipment;
import ai.timefold.solver.benchmarks.examples.pas.domain.Gender;
import ai.timefold.solver.benchmarks.examples.pas.domain.GenderLimitation;
import ai.timefold.solver.benchmarks.examples.pas.domain.Night;
import ai.timefold.solver.benchmarks.examples.pas.domain.Patient;
import ai.timefold.solver.benchmarks.examples.pas.domain.PatientAdmissionSchedule;
import ai.timefold.solver.benchmarks.examples.pas.domain.PreferredPatientEquipment;
...
class PatientAdmissionScheduleConstraintProviderTest
        extends
        AbstractConstraintProviderTest<PatientAdmissionScheduleConstraintProvider, PatientAdmissionSchedule> {
    ...
    private final ConstraintVerifier<PatientAdmissionScheduleConstraintProvider, PatientAdmissionSchedule> constraintVerifier =
            ConstraintVerifier
                    .build(new PatientAdmissionScheduleConstraintProvider(),
    ...
    void sameBedInSameNightConstraintTest(
        ...
        constraintVerifier.verifyThat(
                PatientAdmissionScheduleConstraintProvider::sameBedInSameNightConstraint)
    ...
    void requiredPatientEquipmentConstraintTest(
        ...
        constraintVerifier.verifyThat(
                PatientAdmissionScheduleConstraintProvider::requiredPatientEquipmentConstraint)
    ...
    void differentGenderInSameGenderRoomInSameNightConstraintTest(
        ...
        constraintVerifier
                .verifyThat(
                        PatientAdmissionScheduleConstraintProvider::differentGenderInSameGenderRoomInSameNightConstraint)
    ...
    void assignEveryPatientToABedConstraintTest(
        ...
        constraintVerifier
                .verifyThat(
                        PatientAdmissionScheduleConstraintProvider::assignEveryPatientToABedConstraint)
    ...
    void preferredMaximumRoomCapacityConstraintTest(
        ...
        constraintVerifier
                .verifyThat(
                        PatientAdmissionScheduleConstraintProvider::preferredMaximumRoomCapacityConstraint)
    ...
    void preferredPatientEquipmentConstraintTest(
        ...
        constraintVerifier.verifyThat(
                PatientAdmissionScheduleConstraintProvider::preferredPatientEquipmentConstraint)
    ...
    void departmentSpecialismConstraintTest(
        ...
        constraintVerifier.verifyThat(
                PatientAdmissionScheduleConstraintProvider::departmentSpecialismConstraint)
    ...
    void roomSpecialismConstraintTest(
        ...
        constraintVerifier.verifyThat(
                PatientAdmissionScheduleConstraintProvider::roomSpecialismNotExistsConstraint)
    ...
    void roomSpecialismNotFirstPriorityConstraintConstraintTest(
        ...
        constraintVerifier.verifyThat(
                PatientAdmissionScheduleConstraintProvider::roomSpecialismNotFirstPriorityConstraint)
                .given(designationWithRoomSpecialism1, designationWithRoomSpecialism2, roomSpecialism)
                .penalizesBy(6);
    }
    ...
    @Override
    protected
            ConstraintVerifier<PatientAdmissionScheduleConstraintProvider, PatientAdmissionSchedule>
