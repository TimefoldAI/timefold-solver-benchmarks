...
import ai.timefold.solver.benchmarks.examples.projectjobscheduling.optional.score.ProjectJobSchedulingIncrementalScoreCalculator;
import ai.timefold.solver.benchmarks.examples.projectjobscheduling.persistence.ProjectJobSchedulingSolutionFileIO;
import ai.timefold.solver.benchmarks.examples.projectjobscheduling.score.ProjectJobSchedulingConstraintProvider;
...
public final class ProjectJobSchedulingProblem extends AbstractProblem<Schedule> {
    ...
    protected Schedule readOriginalSolution() {
        ...
        return solutionFileIO.read(new File("data/projectjobscheduling/projectjobscheduling-B-7.json"));
    }
