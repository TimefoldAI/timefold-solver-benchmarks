package ai.timefold.solver.benchmarks.examples.vehiclerouting.optional.score;
...
public class VehicleRoutingIncrementalScoreCalculator
    ...
    private long getDistanceToDepot(Vehicle vehicle,
    ...
    private long getDistanceFromPreviousStandstill(Vehicle vehicle,
            int index) {
    ...
    private void insertArrivalTime(
            TimeWindowedCustomer customer) {
